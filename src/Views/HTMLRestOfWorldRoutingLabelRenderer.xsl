...
<div id="box">
 ...
 <br> 
 <xsl:choose>
	<xsl:when test="pieceNumber = (../consignmentLabelData/totalNumberOfPieces)">
	...
	<xsl:text>Not Last Page</xsl:text>
	</xsl:otherwise>
 </xsl:choose>
</br>
<!-- 	<xsl:choose>
        on the last page 
        <xsl:when test="pieceNumber = (../consignmentLabelData/totalNumberOfPieces)"/>
		<xsl:when test="$page = (../consignmentLabelData/totalNumberOfPieces)"/>
			<br style="page-break-after:never;"/>
		</xsl:when>
